...
class StateTransitionValidator:
    ...
    ALLOWED_TRANSITIONS: Dict[str, Set[str]] = {
        ...
        "EXECUTING": {"OBSERVING", "VALIDATING", "FIXING", "REVIEWING", "COMPLETED", "FAILED", "CANCELLED"},
        "OBSERVING": {"EXECUTING", "VALIDATING", "FIXING", "REVIEWING", "COMPLETED", "FAILED", "CANCELLED"},
        "VALIDATING": {"FIXING", "REVIEWING", "COMPLETED", "FAILED", "CANCELLED"},
        "FIXING": {"EXECUTING", "FAILED", "CANCELLED"},
